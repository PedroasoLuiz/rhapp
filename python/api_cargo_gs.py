...
SAMPLE_SPREADSHEET_ID = '1WV-aJkDLLFE1RoJFVaUaUv20l5xuLkd6UHBQr2BjpU8'
SAMPLE_RANGE_NAME = 'db_Cargo!A:D'
...
def read_record():
    ...
    try:
        ...
        with open("C:\\Users\\pedro.luiz\\OneDrive - NUTRIALFA\\Área de Trabalho\\Nova pasta\\arq\\json\\api_cargo_gs.json",
                  'w') as arquivo:
