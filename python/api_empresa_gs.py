...
SAMPLE_SPREADSHEET_ID = '1ZxKPucfgW6oJCW7IWRKomtEZfqgd49Mn7-m23d7kT0w'
SAMPLE_RANGE_NAME = 'db_Empresa!A:C'
...
def read_record():
    ...
    try:
        ...
        with open("C:\\Users\\pedro.luiz\\OneDrive - NUTRIALFA\\Área de Trabalho\\Nova pasta\\arq\\json\\api_empresa_gs.json",
                  'w') as arquivo:
