...
SAMPLE_RANGE_NAME = 'Enviados APE!A:K'
...
def read_record():
    ...
    try:
        ...
        with open("C:\\Users\\pedro.luiz\\OneDrive - NUTRIALFA\\Área de Trabalho\\Nova pasta\\arq\\json\\api_ape_sent_gs.json",
                  'w') as arquivo:
...
def update_record(valor_atualizado):
    ...
    try:
        ...
        if linha_encontrada != -1:
            ...
            sheet.values().update(spreadsheetId=SAMPLE_SPREADSHEET_ID, range="B" + str(linha_encontrada),
