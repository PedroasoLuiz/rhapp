...
SAMPLE_SPREADSHEET_ID = '1ksg3_oEyt6-nFcSD7wppcZ8czK_GTvTjNBFo7yAQYqo'
SAMPLE_RANGE_NAME = 'db_Canal!A:D'
...
def read_record():
    ...
    try:
        ...
        with open("C:\\Users\\pedro.luiz\\OneDrive - NUTRIALFA\\Área de Trabalho\\Nova pasta\\arq\\json\\api_canais_gs.json",
                  'w') as arquivo:
