...
Sheet_ID = '1dSS2mm5IeFhpjVGee7_m6b0AESaKa99FeiUsgEE7xJw'
Sheet_range = 'Respostas APE!A:AF'
...
def read_record():
    try:
        ...
        with open(path + "api_ape_v2_0.json", 'w') as arquivo:
        ...
        if os.path.exists(path + "api_ape_v2_0.json"):
            os.remove(path + "api_ape_v2_0.json")
