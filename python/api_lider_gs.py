...
SAMPLE_SPREADSHEET_ID = '1kyjLPrrVTCZS2zKH5u-TW1HzoK1dYtXEy6k9MWUavRU'
SAMPLE_RANGE_NAME = 'db_Lider!A:G'
...
def read_record():
    ...
    try:
        ...
        with open("C:\\Users\\pedro.luiz\\OneDrive - NUTRIALFA\\Área de Trabalho\\Nova pasta\\arq\\json\\api_lider_gs.json",
                  'w') as arquivo:
